...
To estimate the error in this case, we compare the integral value with analytical one, obatained a relative error of ~0.02% with 20 segments in the integral domain. In general case, to estimate the error, we encourage users to refine the grids.
