...
where :math:`x_0, x_1,...,x_n` are equally spaced point. This method is more suitable for linear functions, and accepts arbitrary points (odd or even) per dimension. The truncation eeror for the method is :math:`\mathcal{O}(\Delta x^2)`
